...
Consulte [conceito](docs/pt-BR/01-concept.md), a [introdução a Bitcoin/Lightning/Liquid/Spark](docs/pt-BR/19-bitcoin-lightning-liquid-spark.md), [ativos e meios](docs/pt-BR/04-payment-assets-and-rails.md), [arquitetura](docs/pt-BR/02-architecture.md), [modelo de domínio](docs/pt-BR/03-domain-model.md), [ciclo do pagamento](docs/pt-BR/05-payment-lifecycle.md), [tesouraria e depósitos](docs/pt-BR/18-treasury-and-deposits.md), [execução](docs/pt-BR/06-running-the-demo.md), [integração Breez](docs/pt-BR/07-breez-integration.md), [segurança](docs/pt-BR/08-security-model.md), [solução de problemas](docs/pt-BR/10-troubleshooting.md), [próximos passos](docs/pt-BR/11-next-steps.md) e [notas de implementação](docs/pt-BR/00-implementation-notes.md). Esta é a ordem de leitura guiada; cada capítulo tem navegação anterior/próximo e um link de volta para cá.
