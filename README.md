...
Start with [concept](docs/en-US/01-concept.md), the [Bitcoin/Lightning/Liquid/Spark primer](docs/en-US/19-bitcoin-lightning-liquid-spark.md), [assets and rails](docs/en-US/04-payment-assets-and-rails.md), [architecture](docs/en-US/02-architecture.md), [domain model](docs/en-US/03-domain-model.md), [payment lifecycle](docs/en-US/05-payment-lifecycle.md), [treasury and deposits](docs/en-US/18-treasury-and-deposits.md), [running the demo](docs/en-US/06-running-the-demo.md), [Breez integration](docs/en-US/07-breez-integration.md), [security](docs/en-US/08-security-model.md), [troubleshooting](docs/en-US/10-troubleshooting.md), and [next steps](docs/en-US/11-next-steps.md). Current SDK/release constraints are in [implementation notes](docs/en-US/00-implementation-notes.md). This is the guided reading order; every chapter has prev/next navigation and a link back here.
